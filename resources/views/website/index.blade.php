...
<div class="container-fluid py-3">
    <div class="container">
        <div class="owl-carousel owl-carousel-2 carousel-item-3 position-relative">
            ...
            <div class="d-flex">
                <img src="{{ asset('storage/' . $post->image) }}" style="width: 80px; height: 80px; object-fit: cover;">
                <div class="d-flex align-items-center bg-light px-3" style="height: 80px;">
                    <a class="text-secondary font-weight-semi-bold" href="{{ route('post', $post->id) }}">
                        {{ $post->title }}
                    </a>
                </div>
            </div>
            ...
            <div class="col-lg-8">
                <div class="owl-carousel owl-carousel-2 carousel-item-1 position-relative mb-3 mb-lg-0">
                    ...
                    <div class="position-relative overflow-hidden" style="height: 435px;">
                        ...
                        <div class="overlay">
                            <div class="mb-1">
                                <a class="text-white" href="{{ route('category',$post->category->id) }}">
                                    {{ $post->category->title }}
                                </a>
                            ...
                            <a class="h2 m-0 text-white font-weight-bold" href="{{ route('post',$post->id) }}">
                                {{ $post->title }}
                            </a>
                        </div>
                    </div>
    ...
    <div class="container">
        <div class="row">
            @foreach ($categories_with_posts as $category)
                @if (count($category->latestTwoPosts) > 0)
                <div class="col-lg-6 py-3">
                    <div class="bg-light py-2 px-4 mb-3">
                        <h3 class="m-0">{{ $category->title }}</h3>
                    </div>
                    <div class="owl-carousel owl-carousel-3 carousel-item-2 position-relative">
                        @foreach ($category->latestTwoPosts as $post)
