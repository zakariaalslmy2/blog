...
MultiLangBlog/
├── app/
│   ├── DataTables/              # إعدادات جداول البيانات (Yajra)
│   ├── Http/
│   │   ├── Controllers/
│   │   │   ├── Api/             # متحكمات الـ API (Dashboard integration)
│   │   │   ├── Auth/            # متحكمات المصادقة
│   │   │   ├── Dashboard/       # متحكمات لوحة تحكم الإدارة
│   │   │   └── Website/         # متحكمات الواجهة الأمامية للموقع
│   │   ├── Middleware/          # البرمجيات الوسيطة (Custom Middleware)
│   │   └── Requests/            # طلبات التحقق (Validation Requests)
│   │       ├── categories/
│   │       ├── Posts/
│   │       └── User/
│   ├── Models/                  # نماذج البيانات (Models & Translations)
│   ├── Policies/                # سياسات الصلاحيات (Authorization)
│   ├── Providers/               # مزودو الخدمات
│   └── Services/                # طبقة الخدمات (Business Logic Layer - SOLID)
├── database/
│   ├── migrations/
│   ├── seeders/
│   └── factories/
...
│   └── en/
├── public/
│   ├── admin_assets/            # ملفات تنسيق لوحة التحكم
│   ├── front/                   # ملفات تنسيق الموقع العام
│   └── storage/
├── resources/
│   └── views/
│       ├── dashboard/
